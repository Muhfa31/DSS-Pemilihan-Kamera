    ...
    ?>
            <tr>
                ...
                <td class="text-center">
					<a href="edit-alternatif.php?id=<?php echo $row['idalternatif'] ?>" class="btn btn-warning text-white"><i class="fas fa-pencil-alt"></i></a>
					<a href="hapus-alternatif.php?id=<?php echo $row['idalternatif'] ?>" onclick="return confirm('Yakin ingin menghapus data')" class="btn btn-danger"><span class="fas fa-trash-alt"></span></a>
			    </td>
            </tr>
<?php
}
