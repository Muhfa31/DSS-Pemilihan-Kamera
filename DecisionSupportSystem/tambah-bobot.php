...
if ($_POST) {
	...
	$insert = mysqli_query($koneksi,"INSERT INTO bobot 
								VALUES
								('','$ket','$jm')");
	if ($insert) {
...
<div class="container">
	...
	<form method="POST" action="">
	  <div class="form-group row">
	    <label for="kt" class="col-sm-2 col-form-label">ID Alternatif</label>
	    <div class="col-sm-10">
	      <input type="text" class="form-control" id="kt" name="kt">
	    </div>
	  </div>
	  <div class="form-group row">
	    <label for="jum" class="col-sm-2 col-form-label">Value Bobot</label>
	    <div class="col-sm-10">
